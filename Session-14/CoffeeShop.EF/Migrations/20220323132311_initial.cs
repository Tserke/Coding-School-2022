        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SallaryPerMonth = table.Column<double>(type: "float(10)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransacionLineId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transaction Line", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Transaction Line_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaction Line_Transaction_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction Line_ProductId",
                table: "Transaction Line",
                column: "ProductId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Transaction Line_TransactionId",
                table: "Transaction Line",
